...
import { Paper, TextField, Typography,Container,Box, Button, Grid,Card, CardActionArea, CardContent, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from "@mui/material"
...
export default function Generate(){
    ...
    const handleSubmit = async () => {
        fetch('api/generate', {
            method: 'POST',
            body: JSON.stringify({ text }), // Ensure the body is a JSON string
            headers: {
        ...
        .then((res) => {
            ...
            return res.json(); // Call json() as a function
        })
        ...
        {flashcards.length>0 && (
            <Box sx={{mt:4}}>
                ...
                <Box sx={{mt:4, display:'flex', justifyContent:'center'}}>
                    <Button varient='contained' color="secondary" onClick={handleOpen}>Save</Button>
                </Box>
            </Box>
        )}
